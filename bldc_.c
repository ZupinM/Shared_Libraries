...
//fsta
       if(i == 1 && !(bldc_motors[0].status & BLDC_STATUS_MOVING_OUT) && !(bldc_motors[0].status & BLDC_STATUS_MOVING_IN) ||
        i == 0 && !(bldc_motors[1].status & BLDC_STATUS_MOVING_OUT) && !(bldc_motors[1].status & BLDC_STATUS_MOVING_IN)) {
